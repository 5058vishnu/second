...
class _CarDrivingAnimationState extends State<CarDrivingAnimation>
  ...
  final controlStopCar = LogicalKeySet(LogicalKeyboardKey.keyK);
      ...
      body: Shortcuts(
        ...
        child: Actions(
          actions: <Type, Action<Intent>>{
            StopCarIntent:
                CallbackAction<StopCarIntent>(onInvoke: (intent) => stopCar()),
